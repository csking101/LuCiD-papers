...
#
# Run:
#   manim -qm --media_dir ../output/animations 02_bradley_terry_rm.py BradleyTerryRM
...
def _copy_to_docs():
    src = _PAPER_DIR / "output/animations/videos/02_bradley_terry_rm/720p30/BradleyTerryRM.mp4"
...
class BradleyTerryRM(Scene):
    def construct(self):
        ...
        # ── Title ──
        title = Text("Bradley-Terry Reward Model", font_size=36,
        ...
        # ══════════════════════════════════════════════════════════════
        step1 = Text("Step 1: Two candidate summaries", font_size=26,
        ...
        post_box = RoundedRectangle(corner_radius=0.1, width=2.5, height=0.8,
                                     stroke_color=_SUB, fill_color="#161b22", fill_opacity=0.8)
        post_label = Text("Post x", font_size=20, color=_SUB, font=_FONT)
        ...
        y0_label = Text("Summary y₀", font_size=20, color="#E74C3C", font=_FONT)
        ...
        y1_label = Text("Summary y₁ ✓", font_size=20, color="#3fb950", font=_FONT)
        ...
        preferred = Text("(human prefers y₁)", font_size=18, color="#3fb950", font=_FONT)
        preferred.next_to(inputs, DOWN, buff=0.25)
        ...
        step2 = Text("Step 2: Reward model scores each summary", font_size=26,
                      color="#f0883e", font=_FONT)
        step2.next_to(header, DOWN, buff=0.5)
        self.play(FadeIn(step2))

        # Show r(x, y0) and r(x, y1)
        score0 = MathTex(r"r_\theta(x, y_0) = 1.2", font_size=32, color="#E74C3C")
        score1 = MathTex(r"r_\theta(x, y_1) = 3.8", font_size=32, color="#3fb950")
        ...
        step3 = Text("Step 3: Sigmoid → probability", font_size=26,
        ...
        step4 = Text("Step 4: Cross-entropy loss", font_size=26,
        ...
        ex_title = Text("Putting it together", font_size=26,
